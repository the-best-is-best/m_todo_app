                                    ...
                                    child: MyTextFormField(
                                      ...
                                      validator: (val) {
                                        ...
                                        if (_datelineController
                                          ...
                                          return context.strings().selectDate;
                                        }
                                        ...
                                        if (timeValue
                                            .isAfterAnotherTime(timeEndValue)) {
                                          return context
                                              .strings()
                                ...
                                child: DropdownButtonFormField<int>(
                                  ...
                                  items: [
                                    DropdownMenuItem(
                                      value: 0,
                                      child: MyText(
                                        title: context.strings().tenMinBefore,
                                    ...
                                    DropdownMenuItem(
                                      ...
                                      child: MyText(
                                        title:
                                            context.strings().thirtyMinBefore,
                                        style: getRegularStyle(),
                                      ),
                                    ),
                                    DropdownMenuItem(
                                      value: 2,
                                      child: MyText(
                                        title: context.strings().oneHourBefore,
                                        style: getRegularStyle(),
                                      ),
                                    ),
                                    DropdownMenuItem(
                                      value: 3,
                                      child: MyText(
                                        title: context.strings().oneDayBefore,
                                        style: getRegularStyle(),
                                      ),
                                    ),
                                  ],
                              ...
                              Row(
                                ...
                                children: [
                                  RadioButton<String>(
                                    ...
                                    groupValue:
                                        addTaskCubit.addTaskFreezed.color,
                                    onChanged: (val) {
                                      addTaskCubit.addColor(val!);
                                    },
                                  ),
                                  RadioButton<String>(
