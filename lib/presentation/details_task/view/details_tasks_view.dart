...
class DetailsTasksView extends StatefulWidget {
  ...
  const DetailsTasksView({Key? key, required this.task, this.scheduleCubit})
      : super(key: key);
...
class _DetailsTasksViewState extends State<DetailsTasksView> {
  ...
  void initState() {
    ...
    _datelineController.text = widget.task.date;
                  ...
                  actions: [
                    IconButton(
                        onPressed: () {
                          DetailsTasksCubit detailsTasksCubit =
                              DetailsTasksCubit.get(context);
                          detailsTasksCubit.updateStatus(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    MyText(
                                      ...
                                      style:
                                          getBoldStyle(fontSize: FontSize.s20),
                                    ),
